...
l1=[1,2,3.5]
print(max(l1))-->3.5
index(l1.index(2))-->index which is used to get index value of specific element
l1=[1,2,3,1,2,4]
print(l1.count(1))-->how many times a number was repeated
